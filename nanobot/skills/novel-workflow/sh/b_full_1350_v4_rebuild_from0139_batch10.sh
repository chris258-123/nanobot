...
LOG=/home/chris/Desktop/my_workspace/novel_data/04/new_book/log/b_full_1350_v4_rebuild_from0137_batch5.log
FAILED_BATCHES=/home/chris/Desktop/my_workspace/novel_data/04/new_book/log/b_full_1350_v4_failed_batches.txt
FAILED_CHAPTERS=/home/chris/Desktop/my_workspace/novel_data/04/new_book/log/b_full_1350_v4_failed_chapters.txt
...
echo "[$(date +"%F %T")] ==== START rebuild book=novel_04_b_full_1350_v4 range=0137-1350 batch=5 ====" | tee -a "$LOG"

for s in $(seq 137 5 1350); do
  ...
  for a in 1 2 3; do
    ...
    /home/chris/miniforge3/envs/nanobot/bin/python /home/chris/Desktop/my_workspace/nanobot/nanobot/skills/novel-workflow/scripts/generate_book_ab.py \
      ...
      --resume \
      --resume-overwrite-range 0137-1350 \
      --commit-memory \
